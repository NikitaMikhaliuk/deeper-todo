...
export function AddCategory(parentCategoryId, name, id, linkPath) {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/add-category`, options).then(() => {
      dispatch(action);
    });
  };
}
...
export function DeleteCategory(parentCategoryId, categoryId) {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/delete-category`, options).then(() => {
      dispatch(action);
    });
  };
}
...
export function RenameCategory(id, newName) {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/rename-category`, options).then(() => {
      dispatch(action);
    });
  };
}
...
export function AddTodoItem(id, name, parentCategoryId) {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/add-todotask`, options).then(() => {
      dispatch(action);
    });
  };
}

export function EditTodoItem(id, isCompleted, newName = '', newDescription = '') {
  return (dispatch, getState) => {
    const action = {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/edit-todotask`, options).then(() => {
      dispatch(action);
    });
  };
}
...
export function MoveTodoItem(itemId, newParentCategory) {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/move-todotask`, options).then(() => {
      dispatch(action);
    });
  };
}
...
export function Undo() {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/undo`, options).then(() => {
...
export function Redo() {
  return (dispatch, getState) => {
    ...
    fetch(`/api/todolists/${getState().todoList.toJS()._id}/redo`, options).then(() => {
